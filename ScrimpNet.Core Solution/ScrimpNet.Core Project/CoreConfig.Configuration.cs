        ...
        public class Configuration
        {
            ...
            public static string ExternalSource
            {
                get
                {
                    ...
                    {
                        ScrimpNet.Diagnostics.Log.LastChanceLog(Diagnostics.LogLevel.Warning, "Unable to find <appSettings> key 'ScrimpNet.Configuration.ExternalSource'.  External configuration source might be disabled");
                    }
                    return configSource;
                }
            }
            ...
            public static string WcfUrl
            {
                get
                {
                    ...
                    if (url == null || string.IsNullOrEmpty(url) == true)
                    {
                        ...
                        Diagnostics.Log.LastChanceLog(Diagnostics.LogLevel.Error, msg);
