    ...
    public sealed partial class ConfigManager
    {
        ...
        public static T AppSetting<T>(string key)
        {
            ...
            if (configValue == null)
            {
                ...
                Log.LastChanceLog( LogLevel.Error,msg);
        ...
        /// </summary>
        /// <param name="configValue">String containingone or more tokens</param>
        ...
        public static string ResolveValueSetting(string configValue)
        {
            ...
            configValue = ResolveKeyTokens(configValue);
            ...
            for (var x = matches.Count - 1; x >= 0; x--)
            {
                ...
                {
                    case "app":
                        resolvedValue = ConfigurationManager.AppSettings[ResolveKeyTokens(configKey)];
