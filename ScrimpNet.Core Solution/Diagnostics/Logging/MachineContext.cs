...
namespace ScrimpNet.Core.Diagnostics.Logging
{
    /// <summary>
    ...
    public sealed class MachineContext : IFormattable
    {
        ...
        /// <summary>
        /// Name of first non-Utilities class within this stack trace.  NOTE:  Will return "" if called from any method within the same namespace as this method. ScrimpNet.Core.Diagnostics.Logging
        /// </summary>
