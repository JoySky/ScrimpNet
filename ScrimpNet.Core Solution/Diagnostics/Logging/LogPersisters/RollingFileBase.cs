...
namespace ScrimpNet.Core.Diagnostics
{
    ...
    /// </summary>
    public abstract class RollingLogBase : ILogPersister, IDisposable
    {
        ...
        protected abstract void FormatMessage(StringBuilder sb, LogMessageBase msg);
        ...
        public bool PersistMessages(IEnumerable<LogMessageBase> messageBlock)
        {
            List<LogMessageBase> messageList = messageBlock as List<LogMessageBase>;
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        LogMessageBase msg = messageList[x];
