...
namespace ScrimpNet.Core
{
    ...
    public static partial class Utils
    {
        ...
        public static T NewException<T>(string message, params object[] args) where T: Exception
        {
        ...
        public static T NewException<T>(Exception innerException, string message, params object[] args) where T : Exception
        {
            Type exceptionType = typeof(T);
